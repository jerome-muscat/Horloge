...
def afficher_heure():
    ...
    while True:
        changement_heure = input("Voulez vous régler l'horloge et changer l'heure ? ")
...
def horloge(alarme):
    ...
    while True:
        ...
        if reponse_alarme.lower() == "oui":
            alarme = input("Vous voulez programmer une alarme à quelle heure ? \nVotre saisie doit être sous format HH:MM:SS ")
